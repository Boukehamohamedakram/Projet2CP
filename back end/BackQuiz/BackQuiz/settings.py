"""
Django settings for BackQuiz project.
...
SECRET_KEY = 'django-insecure-@h+))x6l91od78+paah0gax0e8zw0xz0(mov8s579muvu-yei1'
...
WSGI_APPLICATION = 'BackQuiz.wsgi.application'
