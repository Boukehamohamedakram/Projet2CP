...
const Quizzes = () => {
  ...
  const saveQuiz = (quiz, isDraft) => {
    ...
    return {
      success: true,
      message: `Quiz ${isDraft ? "saved as draft" : "published"} successfully!`,
      id,
    };
  };
          ...
          if (existingIndex > -1) {
            ...
            return [
              ...prevQuizzes,
              {
                ...
                id:
                  result.id ||
                  `${isDraft ? "draft" : "published"}-${Date.now()}`,
              },
            ];
          }
        });
          ...
          {saveResult && (
            <div
              style={{
                ...
                border: `1px solid ${
                  saveResult.success ? "#34d399" : "#f87171"
                }`,
                    ...
                    draftQuizzes.map((quiz) => (
                      ...
                      >
                        ...
                        >
                          <button
                            onClick={() =>
                              handleSaveQuizFromCreated(quiz, true)
                            }
                            style={{
                              backgroundColor: "#3b82f6",
                              color: "white",
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateQuestion({
                        answers: { ...tfAnswers, [value]: e.target.checked },
                      })
                    }
                    style={{
                      width: "1.5rem",
              ...
              >
                <input
                  ...
                  onChange={(e) => {
                    ...
                    updateQuestion({
                      answers: { ...mcAnswers, options: newOptions },
                    });
                  }}
                  style={{
                    flexGrow: 1,
        ...
        {questions.map((_, index) => (
          <div
            ...
            style={{
              ...
              borderRadius: "50%",
              backgroundColor:
                index === currentQuestionIndex ? "#3b82f6" : "#cbd5e1",
              margin: "0 2px",
              transition: "all 0.2s ease",
              transform:
                index === currentQuestionIndex ? "scale(1.3)" : "scale(1)",
              cursor: "pointer",
            }}
                    ...
                    <div style={{ marginBottom: "1rem" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center" }}>
                        <input
                          ...
                          onChange={(e) =>
                            updateQuestion({ mark: Number(e.target.value) })
                          }
                          style={{
                            width: "6rem",
                            height: "3rem",
                        ...
                        >
                          Total allocated: {currentTotalMarks}/
                          {quizMetadata.totalMark}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  >
                    ...
                    >
                      ...
                      <p>
                        <span style={{ fontWeight: "500" }}>Total Mark:</span>{" "}
                        {quizMetadata.totalMark}
                      </p>
                      <p>
                        <span style={{ fontWeight: "500" }}>Section:</span>{" "}
                        {quizMetadata.section || "-"}
                      </p>
                      <p>
                  ...
                  {questions.map((q, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <p>
                          <span style={{ fontWeight: "500" }}>Mark:</span>{" "}
                          {q.mark}
                        </p>
                      </div>
                      {q.type !== "OnScreen" && (
